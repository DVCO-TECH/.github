...
# 🚀 Michel Jorge Silva Teixeira
### **Founder & Systems Analyst na DVCO TECH | Gestor Pedagógico | Professor**
...
Sólida formação matemática combinada com a agilidade da engenharia de software e análise de sistemas. Atuo no ponto exato de intersecção entre a **educação tecnológica** e a **inteligência de negócios**.

- 🔭 **Fundador da [DVCO TECH](#)**: Lidero projetos de automação, Business Intelligence (BI) e desenvolvimento web/PWA para os setores público e privado.
- 🎓 **Educação & Gestão**: Coordenador de Gestão Pedagógica (SEDUC-SP) e Professor de Ensino Técnico na ETEC de Santa Isabel.
- 📐 **Lógica & Precisão**: Licenciado em Matemática (UMC) e Analista & Desenvolvedor de Sistemas (FATEC-SP).
- 💬 **Fale comigo sobre**: Business Intelligence, Modelagem de Dados, Arquitetura SQL, React, Python e Gestão Educacional.
...
*"Transformando dados complexos em decisões simples e processos lentos em fluxos eficientes."*
